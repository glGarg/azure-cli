...
examples:
  ...
  - name: Creates a security contact. (autogenerated)
    text: |
        az security contact create --alert-notifications 'on' --alerts-admins 'on' --email 'john@contoso.com' --name "default1" --phone '(214)275-4038' --subscription MySubscription
    crafted: true
"""
