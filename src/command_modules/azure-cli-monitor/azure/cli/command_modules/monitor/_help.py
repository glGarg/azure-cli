...
examples:
  ...
  - name: Update the details of this activity log alert (commonly used with --output). (autogenerated)
    text: |
        az monitor activity-log alert update --description "High CPU" --name MyActivityLogAlerts --resource-group MyResourceGroup
    crafted: true
"""
