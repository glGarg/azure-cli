...
examples:
  - name: Create a new action group (autogenerated)
    text: az monitor action-group create --name MyActionGroup --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete an alert rule. (autogenerated)
    text: az monitor alert delete --ids {RuleResourceId}
    crafted: true
"""
...
examples:
  - name: Update a classic metric-based alert rule. (autogenerated)
    text: az monitor alert update --enabled true --ids {RuleResourceId}
    crafted: true
"""
...
examples:
  - name: Updates an autoscale setting. (autogenerated)
    text: az monitor autoscale-settings update --name MyAutoscaleSetting --resource-group MyResourceGroup --set {set}
    crafted: true
"""
...
examples:
  - name: Update diagnostic settings. (autogenerated)
    text: az monitor diagnostic-settings update --name MyDiagnosticSetting --resource myScaleSet --set {set}
    crafted: true
"""
...
examples:
  - name: Lists the metric definitions for the resource. (autogenerated)
    text: az monitor metrics list-definitions --resource myScaleSet
    crafted: true
"""
