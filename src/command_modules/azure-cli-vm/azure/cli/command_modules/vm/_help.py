...
examples:
  - name: Delete a managed disk. (autogenerated)
    text: az disk delete --name MyManagedDisk --resource-group MyResourceGroup --yes
    crafted: true
"""
...
examples:
  - name: Update a snapshot. (autogenerated)
    text: az snapshot update --name MySnapshot --remove {remove} --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  ...
  - name: Delete an availability set. (autogenerated)
    text: |
        az vm availability-set delete --ids $(az vm availability-set list --resource-group MyResourceGroup --query "[].id" --output tsv)
    crafted: true
"""
...
examples:
  ...
  - name: Attach a managed persistent disk to a VM. (autogenerated)
    text: az vm disk attach --disk $diskId --new --resource-group MyResourceGroup --size-gb 50 --sku Standard_LRS --vm-name MyVm
    crafted: true
"""
