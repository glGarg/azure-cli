...
examples:
  - name: Create a redis cache firewall rule. (autogenerated)
    text: az redis firewall-rules create --end-ip {end-ip} --name MyRedisCache --resource-group MyResourceGroup --rule-name MyRule --start-ip {start-ip}
    crafted: true
"""
