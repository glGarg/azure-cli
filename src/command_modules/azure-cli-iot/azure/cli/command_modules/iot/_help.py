...
examples:
  - name: Get the details of a job in an IoT hub. (autogenerated)
    text: az iot hub job show --hub-name MyHub --job-id {job-id}
    crafted: true
"""
...
examples:
  ...
  - name: Update a route in IoT Hub. (autogenerated)
    text: az iot hub route update --condition true --enabled true --endpoint-name MyEndpoint --hub-name MyIotHub --route-name R1 --source-type invalid
    crafted: true
  - name: Update a route in IoT Hub. (autogenerated)
    text: az iot hub route update --enabled true --hub-name MyIotHub --resource-group MyResourceGroup --route-name R1
    crafted: true
"""
...
examples:
  - name: Get the statistics for an IoT hub. (autogenerated)
    text: az iot hub show-stats --ids {ids}
    crafted: true
"""
