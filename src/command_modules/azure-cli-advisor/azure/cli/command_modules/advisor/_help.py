...
examples:
  - name: Disable Azure Advisor recommendations. (autogenerated)
    text: az advisor recommendation disable --days {days} --name MyRecommendationAsOutputByListCommand
    crafted: true
"""
...
examples:
  - name: Enable Azure Advisor recommendations. (autogenerated)
    text: az advisor recommendation enable --name MyRecommendationAsOutputByListCommand
    crafted: true
"""
