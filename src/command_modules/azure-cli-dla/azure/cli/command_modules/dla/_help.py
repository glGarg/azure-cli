...
examples:
  - name: Links an Azure Storage account to the specified Data Lake Analytics account. (autogenerated)
    text: |
        az dla account blob-storage add --access-key "{Azure Storage Account Key}" --account "{Data Lake Analytics account name}" --storage-account-name MyStorageAccount
    crafted: true
"""
...
examples:
  - name: Create a Data Lake Analytics account. (autogenerated)
    text: |
        az dla account create --account "{Data Lake Analytics account name}" --default-data-lake-store "{Data Lake Store account name}" --location westus2 --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete a Data Lake Analytics account. (autogenerated)
    text: |
        az dla account delete --account "{Data Lake Analytics account name}" --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Get the details of a Data Lake Analytics account. (autogenerated)
    text: |
        az dla account show --account "{Data Lake Analytics account name}" --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update a Data Lake Analytics account. (autogenerated)
    text: |
...
examples:
  - name: Create a new catalog credential for use with an external data source. (autogenerated)
    text: |
        az dla catalog credential create --account "{Data Lake Analytics account name}" --credential-name MyCredential --database-name MyDatabase --password {password} --uri {uri} --user-name MyUser
    crafted: true
"""
...
examples:
  - name: Delete a catalog credential. (autogenerated)
    text: |
        az dla catalog credential delete --account "{Data Lake Analytics account name}" --credential-name MyCredential --database-name MyDatabase
    crafted: true
"""
...
examples:
  - name: Retrieve a catalog credential. (autogenerated)
    text: |
        az dla catalog credential show --account "{Data Lake Analytics account name}" --credential-name MyCredential --database-name MyDatabase
    crafted: true
"""
...
examples:
  - name: List Data Lake Analytics jobs. (autogenerated)
    text: |
...
examples:
  - name: List job pipelines in a Data Lake Analytics account. (autogenerated)
    text: |
