...
examples:
  ...
  - name: Generates a shared access signature for the file (autogenerated)
    text: az storage file generate-sas --account-key 00000000 --account-name MyStorageAccount --connection-string $AZURE_STORAGE_CONNECTION_STRING --expiry $end --https-only --path path/file.txt --permissions rcdw --share-name MyShare --subscription MySubscription
    crafted: true
"""
...
examples:
  ...
  - name: Generates a shared access signature for the share. (autogenerated)
    text: az storage share generate-sas --connection-string $AZURE_STORAGE_CONNECTION_STRING --expiry 2019-02-01T12:20Z --name MyShare --permissions dlrw
    crafted: true
"""
