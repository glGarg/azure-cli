...
examples:
  - name: Update storage blob service properties. (autogenerated)
    text: az storage blob service-properties update --404-document {ERROR_DOCUMENT_NAME} --account-name MyAccount --index-document {INDEX_DOCUMENT_NAME} --static-website true
    crafted: true
"""
...
examples:
  - name: Copy multiple files or blobs to a file share. (autogenerated)
    text: |
        az storage file copy start-batch --account-key 00000000 --account-name MyAccount --destination-share "myshare" --pattern *.py --source-account-key MySourceKey --source-account-name MySourceAccount --source-share share1
    crafted: true
"""
...
examples:
  - name: Download files from an Azure Storage File Share to a local directory in a batch operation. (autogenerated)
    text: az storage file download-batch --account-name MyAccount --destination . --source MyContainer
    crafted: true
"""
...
examples:
  - name: Check for the existence of a file. (autogenerated)
    text: az storage file exists --account-key 00000000 --account-name MyAccount --path IMG_0966.JPG --share-name MyShare
    crafted: true
"""
...
examples:
  ...
  - name: Upload a file to a share that uses the SMB 3.0 protocol. (autogenerated)
    text: az storage file upload --account-key 00000000 --account-name MyStorageAccount --path IMG_0966.JPG --share-name MyShare --source /path/to/file
    crafted: true
"""
...
examples:
  - name: Upload files from a local directory to an Azure Storage File Share in a batch operation. (autogenerated)
    text: az storage file upload-batch --account-key 00000000 --account-name MyAccount --destination MyContainer --source /path/to/file
    crafted: true
"""
...
examples:
  - name: Create the url to access a file. (autogenerated)
    text: az storage file url --connection-string $AZURE_STORAGE_CONNECTION_STRING --path IMG_0966.JPG --share-name MyShare
    crafted: true
"""
...
examples:
  - name: Update logging settings for a storage account. (autogenerated)
    text: az storage logging update --account-key 00000000 --account-name MyAccount --log {log} --retention {retention} --services bfqt
    crafted: true
"""
...
examples:
  - name: Update metrics settings for a storage account. (autogenerated)
    text: az storage metrics update --account-name MyAccount --hour true --minute true --retention {retention} --services bfqt
    crafted: true
"""
...
examples:
  - name: Check for the existence of a file share. (autogenerated)
    text: az storage share exists --account-key 00000000 --account-name MyAccount --connection-string $AZURE_STORAGE_CONNECTION_STRING --name MyFileShare
    crafted: true
"""
