...
examples:
  - name: Lists all of the applications available in the specified account. (autogenerated)
    text: az batch application summary list --account-endpoint {account-endpoint} --account-name MyAccount
    crafted: true
"""
...
long-summary: This operation returns only applications and versions that are available for use on compute nodes; that is, that can be used in an application package reference. For administrator information about applications and versions that are not yet available to compute nodes, use the Azure portal or the 'az batch application list' command.
examples:
  - name: Gets information about the specified application. (autogenerated)
    text: az batch application summary show --account-endpoint {account-endpoint} --account-key {account-key} --account-name MyAccount --application-id {application-id} --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Add a certificate to a Batch account. (autogenerated)
    text: az batch certificate create --account-endpoint {account-endpoint} --account-key {account-key} --account-name MyAccount --certificate-file {certificate-file} --password ImpossibleToGuessPassword --thumbprint {thumbprint}
    crafted: true
"""
...
examples:
  - name: List all of the jobs or job schedule in a Batch account. (autogenerated)
    text: az batch job list --account-endpoint {account-endpoint} --account-key {account-key} --account-name MyAccount
    crafted: true
"""
...
examples:
  - name: Add a Batch job schedule to an account. (autogenerated)
    text: az batch job-schedule create --account-endpoint {account-endpoint} --account-name MyAccount --id mypool --job-manager-task-command-line {job-manager-task-command-line} --job-manager-task-id {job-manager-task-id} --pool-id mypool --recurrence-interval {recurrence-interval}
    crafted: true
"""
...
examples:
  - name: Get lifetime summary statistics for all of the pools in a Batch account. (autogenerated)
    text: az batch pool all-statistics show --account-endpoint {account-endpoint} --account-key {account-key} --account-name MyAccount
    crafted: true
"""
...
examples:
  - name: Resize or stop resizing a Batch pool. (autogenerated)
    text: az batch pool resize --pool-id myrenderpool --target-dedicated-nodes 0 --target-low-priority-nodes 6
    crafted: true
"""
...
examples:
  - name: Update the properties of a Batch pool. Updating a property in a subgroup will reset the unspecified properties of that group. (autogenerated)
    text: az batch pool set --account-endpoint {account-endpoint} --account-name MyAccount --application-package-references {application-package-references} --pool-id mypool
    crafted: true
"""
...
examples:
  - name: Create Batch tasks. (autogenerated)
    text: az batch task create --account-endpoint {account-endpoint} --account-key {account-key} --account-name MyAccount --application-package-references {application-package-references} --command-line {command-line} --job-id myjob --resource-files {resource-files} --task-id mytask1
    crafted: true
"""
