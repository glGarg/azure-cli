...
examples:
  ...
  - name: Create a new Azure Service Fabric cluster. (autogenerated)
    text: az sf cluster create --certificate-output-folder . --certificate-password $Password --certificate-subject-name cluster1 --cluster-name cluster1 --cluster-size 4 --location westus --resource-group group-name --vault-name MyVault --vault-resource-group $ResourceGroupName --vm-os WindowsServer2012R2Datacenter --vm-password Password#1234 --vm-user-name MyVmUser
    crafted: true
"""
