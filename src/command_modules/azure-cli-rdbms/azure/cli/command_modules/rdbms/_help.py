...
examples:
  ...
  - name: Update a server. (autogenerated)
    text: az mariadb server update --name testsvrnew --resource-group testgroup --sku-name GP_Gen5_4 --storage-size 51200
    crafted: true
  - name: Update a server. (autogenerated)
...
examples:
  - name: Delete a firewall rule. (autogenerated)
    text: az mysql server firewall-rule delete --name MyFirewallRule --resource-group MyResourceGroup --server-name MyServer --yes
    crafted: true
"""
...
examples:
  - name: Delete a firewall rule. (autogenerated)
    text: az postgres server firewall-rule delete --name MyFirewallRule --resource-group MyResourceGroup --server-name MyServer --yes
    crafted: true
"""
...
examples:
  ...
  - name: Stop replication to a read replica and make it a read/write server. (autogenerated)
    text: az postgres server replica stop --name testreplsvr --resource-group testgroup --yes
    crafted: true
"""
