...
examples:
  - name: Register a cloud. (autogenerated)
    text: |
        az cloud register --endpoint-active-directory "https://adfs.local.azurestack.external/adfs/" --endpoint-active-directory-graph-resource-id "https://graph.local.azurestack.external/" --endpoint-management {endpoint-management} --endpoint-resource-manager "https://management.local.azurestack.external" --name MyRegisteredCloud
    crafted: true
"""
