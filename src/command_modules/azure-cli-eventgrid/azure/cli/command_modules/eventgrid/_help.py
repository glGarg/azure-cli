...
examples:
  ...
  - name: Delete a topic. (autogenerated)
    ...
    crafted: true
  - name: Delete a topic. (autogenerated)
    text: az eventgrid topic delete --name topic1 --resource-group rg1 --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: List the event types supported by a topic type. (autogenerated)
    text: az eventgrid topic-type list-event-types --name MyTopicType
    crafted: true
"""
