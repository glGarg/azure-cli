...
examples:
  - name: Get catalog of available reservation. (autogenerated)
    text: az reservations catalog show --location westus2 --reserved-resource-type VirtualMachines --subscription-id {subscription-id}
    crafted: true
"""
...
examples:
  - name: Get all reservations. (autogenerated)
    text: az reservations reservation list --reservation-order-id {reservation-order-id}
    crafted: true
"""
...
examples:
  - name: Get details of a reservation. (autogenerated)
    text: az reservations reservation show --reservation-id {reservation-id} --reservation-order-id {reservation-order-id}
    crafted: true
"""
...
examples:
  - name: Get a specific reservation order. (autogenerated)
    text: az reservations reservation-order show --reservation-order-id {reservation-order-id}
    crafted: true
"""
...
examples:
  - name: Get list of applicable reservation order ids. (autogenerated)
    text: az reservations reservation-order-id list --subscription-id {subscription-id}
    crafted: true
"""
