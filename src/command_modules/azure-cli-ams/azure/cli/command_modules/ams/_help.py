...
examples:
  ...
  - name: Create a transform. (autogenerated)
    text: |
        az ams transform create --account-name myAmsAccount --description 'a simple Transform for Adaptive Bitrate Encoding' --name transformName --preset "C:\\MyPresets\\CustomPreset.json" --resource-group myResourceGroup
    crafted: true
"""
