...
examples:
  - name: Create an Azure Media Services account. (autogenerated)
    text: az ams account create --name MyAzureMediaServicesAccount --resource-group MyResourceGroup --storage-account amsstorageaccount
    crafted: true
"""
...
examples:
  - name: Set the type and number of media reserved units for an Azure Media Services account. (autogenerated)
    text: az ams account mru set --count {count} --name MyAzureMediaServicesAccount --resource-group MyResourceGroup --type {type}
    crafted: true
"""
...
examples:
  - name: Generate a new client secret for a service principal configured for an Azure Media Services account. (autogenerated)
    text: az ams account sp reset-credentials --account-name MyAccount --name MyAppAppURI --password mySecret --resource-group MyResourceGroup --years {years}
    crafted: true
"""
...
examples:
  - name: Delete an account filter. (autogenerated)
    text: az ams account-filter delete --account-name MyAccount --name MyAccountFilter --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update the details of an account filter. (autogenerated)
    text: az ams account-filter update --account-name MyAccount --name MyAccountFilter --resource-group MyResourceGroup --tracks @C:\\tracks.json
    crafted: true
"""
...
examples:
  - name: List streaming locators which are associated with this asset. (autogenerated)
    text: az ams asset list-streaming-locators --account-name MyAccount --ids {ids} --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Create a new content key policy. (autogenerated)
    text: az ams content-key-policy create --account-name MyAccount --description newDescription --name MyContentKeyPolicy --open-restriction --policy-option-name MyPolicyOption --resource-group MyResourceGroup --widevine-template {widevine-template}
    crafted: true
"""
...
examples:
  - name: Add a new option to an existing content key policy. (autogenerated)
    text: az ams content-key-policy option add --account-name MyAccount --ask {ask} --fair-play-pfx {fair-play-pfx} --fair-play-pfx-password {fair-play-pfx-password} --name MyContentKeyPolicy --open-restriction --policy-option-name MyPolicyOption --rental-and-lease-key-type {rental-and-lease-key-type} --rental-duration {rental-duration} --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Start a job. (autogenerated)
    text: az ams job start --account-name MyAccount --base-uri 'https://nimbuscdn-nimbuspm.streaming.mediaservices.windows.net/00000000-0000-0000-0000-000000000000/' --files 'Ignite-short.mp4' --name MyJob --output-assets testOutputAssetName= --resource-group MyResourceGroup --transform-name MyTransform
    crafted: true
"""
...
examples:
  - name: Create a live output. (autogenerated)
    text: az ams live-output create --account-name MyAccount --archive-window-length {archive-window-length} --asset-name MyAsset --live-event-name MyLiveEvent --name MyLiveOutput --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete a live output. (autogenerated)
    text: az ams live-output delete --ids {ids}
    crafted: true
"""
...
examples:
  - name: Create a streaming endpoint. (autogenerated)
    text: az ams streaming-endpoint create --account-name MyAccount --name MyStreamingEndpoint --resource-group MyResourceGroup --scale-units {scale-units}
    crafted: true
"""
...
examples:
  - name: Stop a streaming endpoint. (autogenerated)
    text: az ams streaming-endpoint stop --ids {ids} --no-wait
    crafted: true
"""
...
examples:
  - name: Show the details of a streaming locator. (autogenerated)
    text: az ams streaming-locator show --account-name MyAccount --ids {ids} --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Create a streaming policy. (autogenerated)
    text: az ams streaming-policy create --account-name MyAccount --cenc-clear-tracks {cenc-clear-tracks} --cenc-default-key-label {cenc-default-key-label} --cenc-disable-play-ready true --cenc-key-to-track-mappings {cenc-key-to-track-mappings} --cenc-protocols {cenc-protocols} --name MyStreamingPolicy --resource-group MyResourceGroup
    crafted: true
"""
