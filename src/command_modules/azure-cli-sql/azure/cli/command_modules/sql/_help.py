...
examples:
  - name: Delete a database. (autogenerated)
    text: az sql db delete --name MyAzureSQLDatabase --resource-group MyResourceGroup --server myserver --yes
    crafted: true
"""
...
examples:
  - name: Set the primary replica database by failing over from the current primary replica database. (autogenerated)
    text: az sql db replica set-primary --name MyDatabase --resource-group MyResourceGroup --server myserver
    crafted: true
"""
...
examples:
  - name: Create a new database by restoring from a backup. (autogenerated)
    text: |
        az sql db restore --dest-name MyDest --ids {ids} --server myserver --time "2018-05-20T05:34:22"
    crafted: true
"""
...
examples:
  - name: Create a data warehouse (autogenerated)
    text: az sql dw create --name MyDataWarehouse --resource-group MyResourceGroup --server myserver
    crafted: true
"""
...
examples:
  ...
  - name: Update an elastic pool. (autogenerated)
    text: az sql elastic-pool update --capacity 1 --edition GeneralPurpose --max-size 250GB --name mypool --resource-group mygroup --server myserver
    crafted: true
"""
...
examples:
  - name: Updates the failover group. (autogenerated)
    text: az sql failover-group update --add-db {add-db} --name MyFailoverGroup --resource-group MyResourceGroup --server myserver --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Create a new server Active Directory administrator. (autogenerated)
    text: az sql server ad-admin create --display-name MyDisplay --object-id {principalid_from_last_step} --resource-group MyResourceGroup --server-name MyServer
    crafted: true
"""
...
examples:
  - name: Update an existing server Active Directory administrator. (autogenerated)
    text: az sql server ad-admin update --display-name MyDisplay --object-id {principalid_from_last_step} --resource-group MyResourceGroup --server-name MyServer
    crafted: true
"""
...
examples:
  - name: Creates a server key. (autogenerated)
    text: az sql server key create --kid {kid} --resource-group MyResourceGroup --server myserver
    crafted: true
"""
...
examples:
  - name: Sets the server's encryption protector. (autogenerated)
    text: az sql server tde-key set --kid {kid} --resource-group MyResourceGroup --server myserver --server-key-type ServiceManaged
    crafted: true
"""
