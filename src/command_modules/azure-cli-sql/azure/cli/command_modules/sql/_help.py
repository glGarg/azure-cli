...
examples:
  ...
  - name: Create a managed instance. (autogenerated)
    text: az sql mi create --admin-password mypassword --admin-user myusername --capacity 8 --edition GeneralPurpose --family Gen4 --location mylocation --name myinstance --resource-group mygroup --storage 32GB --subnet /subscriptions/{SubID}/resourceGroups/{ResourceGroup}/providers/Microsoft.Network/virtualNetworks/{VNETName}/subnets/{SubnetName} --vnet-name MyVnet
    crafted: true
"""
...
examples:
  ...
  - name: Delete a managed instance. (autogenerated)
    text: az sql mi delete --name myinstance --no-wait --resource-group mygroup
    crafted: true
"""
...
examples:
  ...
  - name: Delete a managed database. (autogenerated)
    text: az sql midb delete --managed-instance myinstance --name mymanageddb --resource-group mygroup --subscription MySubscription --yes
    crafted: true
"""
