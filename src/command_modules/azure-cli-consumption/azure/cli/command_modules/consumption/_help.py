...
examples:
  - name: Create a budget for an Azure subscription. (autogenerated)
    text: az consumption budget create --amount {amount} --budget-name MyBudget --category cost --end-date 2019-02-01 --resource-group MyResourceGroup --start-date 2019-01-01 --subscription MySubscription --time-grain monthly
    crafted: true
"""
