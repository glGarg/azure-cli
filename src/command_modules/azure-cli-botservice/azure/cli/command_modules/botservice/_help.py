...
examples:
  - name: Get details of the Directline Channel on a bot (autogenerated)
    text: az bot directline show --name MyResourceBot --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Download an existing bot. (autogenerated)
    text: az bot download --name MyResourceBot --resource-group MyResourceGroup --save-path {save-path}
    crafted: true
"""
...
examples:
  - name: Delete the Microsoft Teams Channel on a bot (autogenerated)
    text: az bot msteams delete --name MyResourceBot --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Add scripts to your local source code directory to be able to publish back using `az bot publish`. (autogenerated)
    text: az bot prepare-publish --name MyResourceBot --proj-file-path {proj-file-path} --resource-group MyResourceGroup --sln-name MySln
    crafted: true
"""
...
examples:
  - name: Get details of the Slack Channel on a bot (autogenerated)
    text: az bot slack show --name MyResourceBot --resource-group MyResourceGroup
    crafted: true
"""
