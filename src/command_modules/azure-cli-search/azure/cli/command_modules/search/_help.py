...
examples:
  - name: Update partition and replica of the given search service. (autogenerated)
    text: az search service update --name MySearchService --replica-count {replica-count} --resource-group MyResourceGroup
    crafted: true
"""
