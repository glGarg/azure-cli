...
examples:
  ...
  - name: Create an application gateway. (autogenerated)
    text: az network application-gateway create --capacity 2 --frontend-port 5432 --http-settings-cookie-based-affinity Enabled --http-settings-port 80 --http-settings-protocol Http --location westus2 --name MyAppGateway --public-ip-address MyAppGatewayPublicIp --resource-group MyResourceGroup --sku Standard_Small --subnet MySubnet --vnet-name MyVNet
    crafted: true
"""
...
examples:
  ...
  - name: Update properties of an SOA record. (autogenerated)
    text: az network dns record-set soa update --expire-time {expire-time} --minimum-ttl {minimum-ttl} --refresh-time {refresh-time} --resource-group MyResourceGroup --retry-time {retry-time} --serial-number {serial-number} --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Create a public IP prefix resource. (autogenerated)
    text: az network public-ip prefix create --length {length} --location westus2 --name MyPublicIPPrefix --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Create a virtual network gateway. (autogenerated)
    text: az network vnet-gateway create --gateway-type Vpn --location westus2 --name MyVnetGateway --no-wait --public-ip-addresses {public-ip-addresses} --resource-group MyResourceGroup --sku Basic --vnet MyVnet --vpn-type PolicyBased
    crafted: true
"""
