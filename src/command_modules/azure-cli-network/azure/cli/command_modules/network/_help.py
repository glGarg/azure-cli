...
examples:
  ...
  - name: Update a frontend IP address. (autogenerated)
    text: az network application-gateway frontend-ip update --gateway-name MyAppGateway --name MyFrontendIp --private-ip-address 10.10.10.100 --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Update a probe. (autogenerated)
    text: az network application-gateway probe update --gateway-name MyAppGateway --host-name-from-http-settings true --name MyProbe --resource-group MyResourceGroup --set tags.CostCenter=MyBusinessGroup
    crafted: true
"""
...
examples:
  ...
  - name: Create a rule. (autogenerated)
    text: az network application-gateway rule create --gateway-name MyAppGateway --http-listener MyBackendListener --name MyRule --redirect-config redirectConfig --resource-group MyResourceGroup --rule-type Basic
    crafted: true
"""
...
examples:
  - name: Update an application gateway. (autogenerated)
    text: az network application-gateway update --capacity 2 --name MyApplicationGateway --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Place the CLI in a waiting state until a condition of the application gateway is met. (autogenerated)
    text: az network application-gateway wait --created --name MyAppGateway --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  ...
  - name: Create an empty AAAA record set. (autogenerated)
    text: az network dns record-set aaaa create --name MyRecordSet --resource-group MyResourceGroup --ttl 30 --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  ...
  - name: Create connections between two ExpressRoute circuits. (autogenerated)
    text: |
        az network express-route peering connection create --address-prefix 104.0.0.0/29 --authorization-key "^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^" --circuit-name MyCircuit --name myConnection --peer-circuit MyOtherCircuit --peering-name AzurePrivatePeering --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Update peering settings of an ExpressRoute circuit. (autogenerated)
    text: az network express-route peering update --circuit-name MyCircuit --name MyPeering --remove routeFilter --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Get the details of an ExpressRoute port. (autogenerated)
    text: az network express-route port show --ids vpnConnectionIds
    crafted: true
"""
...
examples:
  ...
  - name: Update a frontend IP address. (autogenerated)
    text: az network lb frontend-ip update --ids vpnConnectionIds --private-ip-address 10.10.10.50
    crafted: true
"""
...
examples:
  ...
  - name: Update a probe. (autogenerated)
    text: az network lb probe update --lb-name MyLb --name MyProbe --port 81 --protocol Http --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Get the details of a network profile. (autogenerated)
    ...
    crafted: true
  - name: Get the details of a network profile. (autogenerated)
    text: az network profile show --ids vpnConnectionIds
    crafted: true
"""
...
examples:
  ...
  - name: Update a public IP address. (autogenerated)
    text: az network public-ip update --dns-name MyLabel --ids $PUBLICIPID
    crafted: true
"""
...
examples:
  ...
  - name: Update a traffic manager profile. (autogenerated)
    text: az network traffic-manager profile update --name MyTmProfile --protocol HTTP --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Update a virtual network. (autogenerated)
    text: az network vnet update --address-prefixes 10.0.0.0/24 --name MyVNet --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: (PREVIEW) Test if a connection can be established between a Virtual Machine and a given endpoint (autogenerated)
    text: az network watcher test-connectivity --dest-address 13.107.21.200 --dest-port 80 --resource-group MyResourceGroup --source-resource MyVmId1
    crafted: true
"""
...
examples:
  ...
  - name: Test IP flow to/from a VM given the currently configured network security group rules (autogenerated)
    text: az network watcher test-ip-flow --direction Inbound --local 10.0.0.4:* --nic myVmVMNic --protocol Tcp --remote 10.1.0.4:80 --resource-group MyResourceGroup --vm MyVm
    crafted: true
"""
