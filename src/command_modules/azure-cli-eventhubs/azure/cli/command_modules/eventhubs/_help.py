...
examples:
  ...
  - name: Deletes the ConsumerGroup (autogenerated)
    text: az eventhubs eventhub consumer-group delete --eventhub-name myeventhub --name myconsumergroup --namespace-name mynamespace --resource-group myresourcegroup --subscription MySubscription
    crafted: true
"""
