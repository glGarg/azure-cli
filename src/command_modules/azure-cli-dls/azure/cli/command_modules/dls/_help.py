...
examples:
  - name: Lists firewall rules in a Data Lake Store account. (autogenerated)
    text: az dls account firewall list --account mydatalakestoragegen1
    crafted: true
"""
...
examples:
  - name: Remove the access control list for a file or folder. (autogenerated)
    text: az dls fs access remove-all --account mydatalakestoragegen1 --path /mynewfolder --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Remove entries for the access control list of a file or folder. (autogenerated)
    text: az dls fs access remove-entry --account mydatalakestoragegen1 --acl-spec user:00000000-0000-0000-0000-000000000000:-w- --path /mynewfolder
    crafted: true
"""
...
examples:
  - name: Set the owner information for a file or folder in a Data Lake Store account. (autogenerated)
    text: az dls fs access set-owner --account mydatalakestoragegen1 --owner 00000000-0000-0000-0000-000000000000 --path /mynewfolder/vehicle1_09142014.csv
    crafted: true
"""
...
examples:
  - name: Set the expiration time for a file. (autogenerated)
    text: az dls fs set-expiry --account mydatalakestoragegen1 --expiration-time {expiration-time} --path /mynewfolder
    crafted: true
"""
