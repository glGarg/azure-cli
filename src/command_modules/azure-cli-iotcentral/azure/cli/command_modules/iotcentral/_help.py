...
examples:
  - name: Update metadata for an IoT Central application. (autogenerated)
    text: az iotcentral app update --name MyIoTCentralApplication --resource-group MyResourceGroup --set {set}
    crafted: true
"""
