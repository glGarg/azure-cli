...
examples:
  - name: Set the web app's configuration. (autogenerated)
...
examples:
  ...
  - name: Create an App Service Plan for an Azure Function (autogenerated)
    text: az functionapp plan create --location westus2 --name MyPlan --number-of-workers 4 --resource-group MyResourceGroup --sku B1
    crafted: true
"""
