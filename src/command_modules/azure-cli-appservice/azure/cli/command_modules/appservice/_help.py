...
examples:
  - name: Update a function app's settings. (autogenerated)
    text: |
        az functionapp config appsettings set --name MyFunctionApp --resource-group MyResourceGroup --settings "APPINSIGHTS_INSTRUMENTATIONKEY = $key"
    crafted: true
"""
...
examples:
  - name: Set a function app container's settings. (autogenerated)
    text: az functionapp config container set --docker-custom-image-name MyDockerCustomImage --docker-registry-server-password {docker-registry-server-password} --docker-registry-server-url {docker-registry-server-url} --docker-registry-server-user {docker-registry-server-user} --name MyFunctionApp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Bind a hostname to a function app. (autogenerated)
    text: az functionapp config hostname add --hostname {hostname} --name MyFunctionApp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Configure a new backup schedule for a web app. (autogenerated)
    text: az webapp config backup update --container-url {container-url} --frequency {frequency} --resource-group MyResourceGroup --retain-one true --retention {retention} --webapp-name MyWebapp
    crafted: true
"""
...
examples:
  - name: Set a web app container's settings. (autogenerated)
    text: az webapp config container set --docker-custom-image-name MyDockerCustomImage --docker-registry-server-password {password} --docker-registry-server-url https://{azure-container-registry-name}.azurecr.io --docker-registry-server-user {registry-username} --name MyWebApp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Unbind a hostname from a web app. (autogenerated)
    text: az webapp config hostname delete --hostname $fqdn --resource-group MyResourceGroup --webapp-name MyWebapp
    crafted: true
"""
...
examples:
  - name: Unbind an SSL certificate from a web app. (autogenerated)
    text: az webapp config ssl unbind --certificate-thumbprint $thumbprint --name MyWebApp --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Get the details for available web app publishing credentials (autogenerated)
    ...
    crafted: true
  - name: Get the details for available web app publishing credentials (autogenerated)
    text: az webapp deployment list-publishing-credentials --name MyWebapp --resource-group MyResourceGroup --slot staging
    crafted: true
"""
...
examples:
  - name: Configure deployment slot auto swap. (autogenerated)
    text: az webapp deployment slot auto-swap --disable --name MyWebapp --resource-group MyResourceGroup --slot staging
    crafted: true
"""
