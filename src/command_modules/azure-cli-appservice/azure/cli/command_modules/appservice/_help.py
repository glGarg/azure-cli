...
examples:
  ...
  - name: Create an app service plan. (autogenerated)
    text: az appservice plan create --name MyPlan --resource-group MyResourceGroup --sku F1 --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Delete an SSL certificate from a web app. (autogenerated)
    text: az webapp config ssl delete --certificate-thumbprint $thumbprint --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  ...
  - name: Update deployment credentials. (autogenerated)
    text: az webapp deployment user set --password somepassword --user-name MyUserName
    crafted: true
"""
