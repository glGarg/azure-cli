...
examples:
  - name: Rotate disk encryption key of the specified HDInsight cluster. (autogenerated)
...
examples:
  - name: Executes script actions on the specified HDInsight cluster. (autogenerated)
    text: az hdinsight script-action execute --name MyCluster --resource-group MyResourceGroup --roles {roles} --script-action-name MyScriptAction --script-uri https://path/to/install/script.sh
    crafted: true
"""
