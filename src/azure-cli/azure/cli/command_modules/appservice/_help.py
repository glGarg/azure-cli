...
examples:
  - name: Update an app service plan. (autogenerated)
    ...
    crafted: true
  - name: Update an app service plan. See https://docs.microsoft.com/en-us/azure/app-service/app-service-plan-manage#move-an-app-to-another-app-service-plan to learn more (autogenerated)
    text: az appservice plan update --name MyAppServicePlan --resource-group MyResourceGroup --sku F1
    crafted: true
"""
...
examples:
  ...
  - name: Update a function app's settings. (autogenerated)
    text: |
        az functionapp config appsettings set --name MyFunctionApp --resource-group MyResourceGroup --settings "AzureWebJobsStorage=$storageConnectionString"
    crafted: true
"""
...
examples:
  - name: Set a function app container's settings. (autogenerated)
    ...
    crafted: true
  - name: Set a function app container's settings. (autogenerated)
    text: az functionapp config container set --docker-custom-image-name MyDockerCustomImage --name MyFunctionApp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Set the function app's configuration. (autogenerated)
    text: az functionapp config set --name MyFunctionApp --resource-group MyResourceGroup --use-32bit-worker-process true
    crafted: true
"""
...
examples:
  - name: Get the details of a web app's configuration. (autogenerated)
    ...
    crafted: true
  - name: Get the details of a function app's configuration. (autogenerated)
    text: az functionapp config show --name MyFunctionApp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Add allowed origins (autogenerated)
    text: az functionapp cors add --allowed-origins https://myapps.com --name MyFunctionApp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Remove allowed origins (autogenerated)
    text: az functionapp cors remove --allowed-origins https://myapps.com --name MyFunctionApp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Get a URL for a git repository endpoint to clone and push to for function app deployment. (autogenerated)
    text: az functionapp deployment source config-local-git --name MyUniqueApp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: assign or disable managed service identity to the web app (autogenerated)
    text: az functionapp identity assign --name MyUniqueApp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: display functionapp's managed service identity (autogenerated)
    ...
    crafted: true
  - name: display web app's managed service identity (commonly used with --output and --query). (autogenerated)
    text: az functionapp identity show --name MyFunctionApp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete an App Service Plan. (autogenerated)
    ...
    crafted: true
  - name: Delete an App Service Plan. (autogenerated)
    text: az functionapp plan delete --name MyAppServicePlan --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  ...
  - name: List App Service Plans. (autogenerated)
    text: az functionapp plan list --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Update an App Service plan for an Azure Function. (autogenerated)
    text: az functionapp plan update --max-burst 20 --name MyPlan --number-of-workers 1 --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  ...
  - name: Update the authentication settings for the webapp. (autogenerated)
    text: az webapp auth update --aad-allowed-token-audiences https://webapp_name.azurewebsites.net/.auth/login/aad/callback --aad-client-id 00000000-0000-0000-0000-000000000000 --aad-client-secret very_secret_password --aad-token-issuer-url https://sts.windows.net/00000000-0000-0000-0000-000000000000/ --action AllowAnonymous --enabled true --name myUniqueApp --resource-group myResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Set a web app's settings. (autogenerated)
    text: az webapp config appsettings set --name MyUniqueApp --resource-group MyResourceGroup --settings WEBSITE_NODE_DEFAULT_VERSION=6.9.1
    crafted: true
parameters:
  - name: --settings
...
examples:
  ...
  - name: Update a web app's connection strings. (autogenerated)
    text: az webapp config connection-string set --connection-string-type MySql --name MyUniqueApp --resource-group MyResourceGroup --settings mysql1='Server=myServer;Database=myDB;Uid=myUser;Pwd=myPwd;'
    crafted: true
"""
...
examples:
  ...
  - name: Set a web app's configuration. (autogenerated)
    text: az webapp config set --always-on true --name MyUniqueApp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Add an Azure storage account configuration to a web app. (Linux Web Apps and Windows Containers Web Apps Only) (autogenerated)
    text: az webapp config storage-account add --access-key MyAccessKey --account-name MyStorageAccount --custom-id CustomId --mount-path /path/to/mount --name MyUniqueApp --resource-group MyResourceGroup --share-name MyShare --storage-type AzureFiles
    crafted: true
"""
...
examples:
  ...
  - name: Remove allowed origins (autogenerated)
    text: az webapp cors remove --allowed-origins https://myapps.com --name MyWebApp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Restore a deleted web app. (autogenerated)
    text: az webapp deleted restore --deleted-id /subscriptions/00000000-0000-0000-0000-000000000000/providers/Microsoft.Web/locations/location/deletedSites/1234 --name MySite --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Get the URL which can be used to configure webhooks for continuous deployment (autogenerated)
    ...
    crafted: true
  - name: Get the URL which can be used to configure webhooks for continuous deployment. (autogenerated)
    text: az webapp deployment container show-cd-url --name MyWebApp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Get the details for available web app publishing credentials (autogenerated)
    ...
    crafted: true
  - name: Get the details for available web app publishing credentials (autogenerated)
    text: az webapp deployment list-publishing-credentials --name MyWebapp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Get the details for available web app deployment profiles. (autogenerated)
    ...
    crafted: true
  - name: Get the details for available web app deployment profiles (autogenerated)
    text: az webapp deployment list-publishing-profiles --name MyWebapp --resource-group MyResourceGroup
    crafted: true
"""
  ...
  - name: Swap a staging slot into production for the MyUniqueApp web app.
    text: >
        az webapp deployment slot swap  -g MyResourceGroup -n MyUniqueApp --slot staging \\
            --target-slot production
  - name: Change deployment slots for a web app. (autogenerated)
    text: az webapp deployment slot swap --name MyUniqueApp --resource-group MyResourceGroup --slot staging --target-slot production
    crafted: true
"""
...
examples:
  - name: Get an endpoint and add it as a git remote.
    text: >
        ...
        git remote add azure \\
            https://{deploy_user_name}@MyUniqueApp.scm.azurewebsites.net/MyUniqueApp.git
  - name: Get a URL for a git repository endpoint to clone and push to for web app deployment. (autogenerated)
    text: az webapp deployment source config-local-git --name MyUniqueApp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: assign or disable managed service identity to the web app (autogenerated)
    text: az webapp identity assign --name MyUniqueApp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: display webapp's managed service identity (autogenerated)
    ...
    crafted: true
  - name: display web app's managed service identity (autogenerated)
    text: az webapp identity show --name MyWebapp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: List all continuous webjobs on a selected webapp. (autogenerated)
    ...
    crafted: true
  - name: List all continuous webjobs on a selected web app. (autogenerated)
    text: az webapp webjob continuous list --name MyWebapp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Run a specific triggered webjob hosted on a web app. (autogenerated)
    text: az webapp webjob triggered run --name MyWebApp --resource-group MyResourceGroup --subscription MySubscription --webjob-name MyWebjob
    crafted: true
"""
