...
examples:
  ...
  - name: List clusters. (autogenerated)
    text: az batchai cluster list --resource-group MyResourceGroup --workspace MyWorkspace
    crafted: true
"""
...
examples:
  ...
  - name: List remote login information for cluster's nodes. (autogenerated)
    text: az batchai cluster node list --cluster MyCluster --resource-group MyResourceGroup --workspace MyWorkspace
    crafted: true
"""
...
examples:
  ...
  - name: Show information about a cluster (autogenerated)
    text: az batchai cluster show --name MyCluster --resource-group MyResourceGroup --workspace MyWorkspace
    crafted: true
"""
...
examples:
  ...
  - name: Stream the content of a file (similar to 'tail -f'). (autogenerated)
    text: az batchai job file stream --experiment MyExperiment --file-name log.txt --job MyJob --output-directory-id OUTPUTS --resource-group MyResourceGroup --workspace MyWorkspace
    crafted: true
"""
...
examples:
  ...
  - name: List jobs (autogenerated)
    text: az batchai job list --experiment MyExperiment --resource-group MyResourceGroup --workspace MyWorkspace
    crafted: true
"""
...
examples:
  ...
  - name: Show information about a job (autogenerated)
    text: az batchai job show --experiment MyExperiment --name MyJob --resource-group MyResourceGroup --workspace MyWorkspace
    crafted: true
"""
