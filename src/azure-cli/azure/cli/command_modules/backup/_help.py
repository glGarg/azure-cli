...
examples:
  - name: Wait until either the job completes or the specified timeout value is reached
    ...
    crafted: true
  - name: Wait until either the job completes or the specified timeout value is reached (autogenerated)
    text: az backup job wait --name MyJob --vault-name MyVault
    crafted: true
"""
...
examples:
  - name: List all items protected by a backup policy
    ...
    crafted: true
  - name: List all items protected by a backup policy. (autogenerated)
    text: az backup policy list-associated-items --name MyBackupPolicy --resource-group MyResourceGroup --vault-name MyVault
    crafted: true
"""
...
examples:
  - name: Show details of a particular policy
    ...
    crafted: true
  - name: Show details of a particular policy. (autogenerated)
    text: az backup policy show --name MyBackupPolicy --resource-group MyResourceGroup --vault-name MyVault
    crafted: true
"""
...
examples:
  - name: Stop protecting a backed up Azure VM. (autogenerated)
    ...
    crafted: true
  - name: Stop protecting a backed up Azure VM. (autogenerated)
    text: az backup protection disable --container-name MyContainer --delete-backup-data true --item-name MyItem --resource-group MyResourceGroup --vault-name MyVault --yes
    crafted: true
"""
