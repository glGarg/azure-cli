...
examples:
  ...
  - name: List access keys of an App Configuration. (autogenerated)
    text: az appconfig credential list --name MyAppConfiguration --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Delete an App Configuration. (autogenerated)
    text: az appconfig delete --name MyAppConfiguration
    crafted: true
"""
...
examples:
  ...
  - name: Delete key-values. (autogenerated)
    text: az appconfig kv delete --key color --label MyLabel --name MyAppConfiguration
    crafted: true
"""
...
examples:
  ...
  - name: Set a key-value. (autogenerated)
    text: az appconfig kv set --key color --name MyAppConfiguration --value red --yes
    crafted: true
"""
...
examples:
  ...
  - name: Show all attributes of a key-value. (autogenerated)
    text: az appconfig kv show --key color --name MyAppConfiguration
    crafted: true
"""
...
examples:
  ...
  - name: Show properties of an App Configuration. (autogenerated)
    text: az appconfig show --name MyAppConfiguration
    crafted: true
"""
...
examples:
  ...
  - name: Update an App Configuration. (autogenerated)
    text: az appconfig update --name MyAppConfiguration --tags key1=value1 key2=value2
    crafted: true
"""
